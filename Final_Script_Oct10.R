...
library(plyr)
library(dplyr)
dat=read.table("C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\Demand.csv",sep=",",header=T)
table(dat$j)
dem1=dat[dat$j==1,]
pairs(dem1)
...
dat=read.table("C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\test_dat2.csv",sep=",",header=T)
...
write.table(test2,"C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\dem_100_2.csv",sep=",",col.names=T,row.names=F)
...
travel=read.table('C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\Travel.csv',sep=',',header=T)
len.dat=read.table('C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\Length.csv',sep=',',header=T)
...
library(prodlim)
dat=read.table("C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\test_dat.csv",sep=",",header=T)
...
write.table(output.test,"C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\travel_50.csv",sep=",",row.names=T,col.names=T)
...
output.test=cbind(index.matrix,output.matrix)
write.table(output.test,"C:\\Users\\HP\\Documents\\Fall 2018\\CSC 522\\2018\\Project\\travel_100.csv",sep=",",row.names=T,col.names=T)
